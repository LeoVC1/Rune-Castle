...
Shader "Shader Graphs/DepthMask/HoleDissolve" {
    Properties {
        ...
        _NoiseScale ("Noise Scale", Range(0, 0.5)) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_5044 = (_MainTex_var.r*node_6902.rgb);
                clip(node_5044 - 0.5);
////// Lighting:
                float3 finalColor = 0;
