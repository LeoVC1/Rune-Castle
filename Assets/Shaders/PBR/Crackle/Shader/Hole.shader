...
Shader "Shader Graphs/DepthMask/Hole" {
    Properties {
        ...
        _Tile ("Tile", Range(0, 2)) = 0
        _InVector2 ("In Vector 2", Vector) = (0,2,0,0)
        _OutVector2 ("Out Vector 2", Vector) = (2,4,0,0)
